...
class ParabolicEdgeDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ParabolicEdgeView(),
    );
  }
}

class ParabolicEdgeView extends StatelessWidget {
  final TextEditingController emailController = TextEditingController();
  final TextEditingController usernameController = TextEditingController();

  ParabolicEdgeView({super.key});
  ...
  Widget _buildRegistrationForm(BuildContext context, double width, double height, bool isMobile, bool isTablet) {
    final authBloc = context.read<AuthBloc>(); // Get the AuthBloc instance

    emailController.addListener(() {
      authBloc.emailSubject.add(emailController.text.trim());
    });

    usernameController.addListener(() {
      authBloc.usernameSubject.add(usernameController.text.trim());
    });
